...
print("center :",str.center(20,"0"))  # center align the string, using a specified character (space is default) as the fill character.
...
print("encode :","My name is Ståle".encode(encoding="ascii",errors="namereplace")) #The encode() method encodes the string, using the specified encoding.
...
# str = "34235"
# str = " "
print("isalnum    :",str.isalnum())   #Returns True if all characters in the string are alphanumeric return false if special character or space
...
print("isprintable :",str.isprintable()) #Returns True if all characters in the string are printable false if like \t \n \a in string
